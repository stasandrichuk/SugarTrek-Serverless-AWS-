...
<html lang="en">
<head>
    <title>Code coverage report for lib/plugins/aws/deploy/compile/events/schedule/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../../../index.html">all files</a> / <a href="index.html">lib/plugins/aws/deploy/compile/events/schedule/</a> index.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (functionObj.events) {
        functionObj.events.forEach(event =&gt; {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (event.schedule) {

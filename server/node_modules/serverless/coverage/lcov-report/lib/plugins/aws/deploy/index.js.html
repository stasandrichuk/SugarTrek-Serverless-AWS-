...
<html lang="en">
<head>
    <title>Code coverage report for lib/plugins/aws/deploy/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/plugins/aws/deploy/</a> index.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
      'deploy:deploy': () =&gt; BbPromise.bind(this)
        ...
        .then(() =&gt; {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.noDeploy) <span class="cstat-no" title="statement not covered" >this.serverless.cli.log('Did not deploy due to --noDeploy');</span>
        }),
    };
  }
}
